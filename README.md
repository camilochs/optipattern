...
```
Once you obtain the fixed probabilities for each node, you can incorporate them into the functioning of a metaheuristic to influence or direct your search. This process is explained in Section “IV - (C) USING LLM OUTPUT TO GUIDE A METAHEURISTIC” of our paper.
